...
- [ ] مزامنة إنهاء Zoom مع حالة الحصة وإغلاق البطاقة فورًا للمعلم والطالب
- [ ] دمج نافذة الحصة داخل صفحة المجموعة مع ملخص حي ودردشة عربية وسبورة مدرك
- [ ] تثبيت زر المزيد وقوائم Zoom وترجمتها داخل التطبيق والموقع
- [ ] تحسين سبورة الكتب: رفع Bunny، صفحات PDF متزامنة، رسم دقيق، وتنقل ثابت
- [ ] توحيد تنزيل تقرير الطالب PDF على الويب وتطبيق Android
- [ ] مطابقة الألوان والأيقونات والمقاسات بصريًا بين الهاتف والكمبيوتر والتابلت
- [ ] تحقق نهائي على الويب وAndroid وتقرير واضح بالتغييرات
