...
DECLARE
  ...
  word text;
  token text;
  stop_words text[] := ARRAY['من','في','على','علي','عن','الى','الي','ان','إن','أن','هو','هي','هما','هم','هن','هذا','هذه','ذلك','تلك','الذي','التي','الذين','او','أو','و','ثم','كما','كل','اي','أي','لا','لم','لن','ما','مع','بين','عند','اذا','إذا','كان','كانت','يكون','تكون','قد','لقد','حتى','حتي','فقط','غير','بعد','قبل','خلال','حول','له','لها','به','بها','فيها','سؤال','السؤال','سوال','السوال','اجابه','اجابة','اعرف','ادري','اعلم','اجب','اجيب','صلاه'];
BEGIN
...
DECLARE
  ...
  phrases text[] := ARRAY[
    ...
    'لا اتذكر','لم اجب','لم اجيب','لم تجب','لم يجيب','لم احل','لم تحل','بدون اجابه','لا توجد اجابه','لا يوجد اجابه',
    'ليس لدي اجابه','لم اجب علي هذا السؤال','لم اجيب علي هذا السؤال','لم تجب علي هذا السؤال','لم تجب على هذا السؤال'
  ];
  phrase text;
  remainder text;
BEGIN
