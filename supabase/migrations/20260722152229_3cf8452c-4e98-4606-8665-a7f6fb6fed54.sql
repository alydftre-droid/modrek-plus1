...
REVOKE EXECUTE ON FUNCTION public.admin_set_withdrawal_schedule(integer, integer, integer, text) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.admin_set_withdrawal_schedule(integer, integer, integer, text) FROM anon;
...
REVOKE EXECUTE ON FUNCTION public.process_scheduled_withdrawal_release() FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.process_scheduled_withdrawal_release() FROM anon;
...
GRANT EXECUTE ON FUNCTION public.admin_financial_overview() TO service_role;