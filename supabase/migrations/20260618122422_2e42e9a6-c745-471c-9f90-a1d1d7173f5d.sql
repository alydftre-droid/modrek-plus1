...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE t.typname = 'exam_question_type' AND e.enumlabel = 'section'
  ) THEN
    ALTER TYPE public.exam_question_type ADD VALUE 'section';
  END IF;
END $$;
...
BEGIN
  ...
  WHERE q.exam_id = _exam_id
    AND q.question_type <> 'section'::exam_question_type;
