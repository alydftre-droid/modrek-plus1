...
BEGIN
  ...
  IF user_role = 'teacher'::public.app_role THEN
    -- Build the list of chosen subjects, preferring meta.subjects if present.
    ...
    -- additional_categories: prefer explicit meta.additional_categories; fall back to
    -- subjects[] minus the primary subject.
