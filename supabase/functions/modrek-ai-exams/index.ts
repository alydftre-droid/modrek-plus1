...
${libraryFound
      ...
      : `لم يُعثر على محتوى كافٍ في المكتبة لهذا الطلب.${researchUsedWeb ? " تم تنفيذ بحث خارجي موثوق تلقائيًا — استخدم المصادر أدناه لبناء الأسئلة." : ""} اعتمد على المنهج الرسمي المناسب للمادة والصف والنظام دون اختراع أسماء دروس، وممنوع الرد بأنك لا تستطيع توليد الامتحان.\n\nسياق إضافي من محتوى المنصة إن وجد:\n${studyContext || "لا يوجد"}`}
