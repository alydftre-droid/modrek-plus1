                ...
                <CardContent className="p-4">
                  ...
                  {req.status === "pending" && (
                    <div className="flex gap-2">
                      <Button size="sm" className="gap-1 flex-1 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white border-0"
                        onClick={() => { setSelectedReq(req); setShowAction("approve"); }}>
                        <CheckCircle className="h-3 w-3" /> موافقة وتحويل
                      </Button>
