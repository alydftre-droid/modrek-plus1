...
export const TEACHER_ASSIGNMENT_CATEGORY_VARIANTS: Record<string, string[]> = {
  ...
  science: ["science", "scientific", "العلوم", "المواد العلمية", "أحياء", "الأحياء", "فيزياء", "الفيزياء", "كيمياء", "الكيمياء", "جيولوجيا", "الجيولوجيا"],
  scientific: ["science", "scientific", "العلوم", "المواد العلمية", "أحياء", "الأحياء", "فيزياء", "الفيزياء", "كيمياء", "الكيمياء", "جيولوجيا", "الجيولوجيا"],
