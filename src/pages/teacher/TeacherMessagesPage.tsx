...
export default function TeacherMessagesPage() {
  ...
  const fetchStudentInfo = async (student: StudentInfo) => {
    ...
    const totalWatchSeconds = videoProgress?.reduce((sum, v) => sum + (v.progress_seconds || 0), 0) || 0;
    const totalDurationSeconds = videoProgress?.reduce((sum, v) => sum + (v.duration_seconds || 0), 0) || 0;
