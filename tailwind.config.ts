  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "float-y": { "0%,100%": { transform: "translateY(0px)" }, "50%": { transform: "translateY(-18px)" } },
        "float-x": { "0%,100%": { transform: "translateX(0px)" }, "50%": { transform: "translateX(14px)" } },
        blob: {
        ...
        "typing-dot": { "0%,60%,100%": { transform: "translateY(0)", opacity: "0.4" }, "30%": { transform: "translateY(-6px)", opacity: "1" } },
      },
      animation: {
