...
COMMENT ON FUNCTION public.select_my_teacher(uuid, text, text, text)
IS 'Atomically selects an approved teacher for the authenticated student inside the active tenant.';
